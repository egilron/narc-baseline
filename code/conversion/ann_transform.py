...
from code.coref_types import (CorefClusters, Markable, MarkableGroup,
                         MarkableReference, Sentences, Tokens)
from code.utils import char_to_word_index, create_character_map, mark_to_idx, expand_child
...
def convert_coref(
    ...
    for mention_cluster in grouped_mentions:
        ...
        for start, end in mention_cluster:
            tmp_cluster.add(char_to_word_index(char_map, start, end))
            # tmp_cluster.add(char_to_word_index(char_map, end))
